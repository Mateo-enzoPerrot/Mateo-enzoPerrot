...
Co-founder of [NexPit](https://nexpit.fr) — automotive software: OBD-II and telemetry
acquisition, time-series processing, embedded vision, mapping applications. Six projects
built in-house by three co-founders.
...
Built in-house at NexPit. Each has a write-up on
[nexpit.fr](https://nexpit.fr/en/projets) covering the problem, the architecture and
the decisions that cost something.

| Project | What it does | Stack |
|---|---|---|
| [Pitlabs](https://nexpit.fr/en/projets/pitlabs) | Sim-racing and track telemetry: channel capture, lap splitting, braking analysis, trajectory comparison | Python, pandas, Tkinter, matplotlib |
| [Embedded systems](https://nexpit.fr/en/projets/systemes-embarques) | 8-channel OBD-II reading, network lap timing on microcontroller, real-time gauges | C, C++, Python, ESP32, TCP sockets |
| [Pr-venx](https://nexpit.fr/en/projets/pr-venx) | Real-time road sign and traffic light detection on a camera stream, hand-annotated datasets | Python, YOLOv8, OpenCV |
| [nexgen3d](https://nexpit.fr/en/projets/nexgen3d) | CLI that reconstructs a textured 3D model from a single photograph, Blender-ready | Python, Hunyuan3D-2, TripoSG, trimesh |
...
The source repositories are private for now. Happy to walk through any of them on request.
...
Each project has a write-up on [nexpit.fr](https://nexpit.fr/en/projets) covering the
problem, the architecture and the decisions that cost something.
